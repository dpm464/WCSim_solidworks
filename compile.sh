...
g++ -c -O2 -o WCSimWCTrigger.o ../src/WCSimWCTrigger.cc -fPIC `root-config --cflags` -I../include
...
g++ -o  timingrefC timingrefC.o   WCSimRootEvent.o  WCSimRootGeom.o  `root-config --glibs` `root-config --cflags` -I../include
rm *.o
